    ...
    return (
        <div className="mt-4">
            ...
            <div className="helpful-links">
                ...
                <li className="mb-1"><a href="#">Career with us</a></li>
                <li className="mb-1"><a href="#">Terms & Conditions</a></li>
                <li className="mb-1"><a href="#">Feedback</a></li>
                <li className="mb-1"><a href="#">Privicy Policy</a></li> <li className="mb-1"><a href="#">Cycling vs Running</a></li>
